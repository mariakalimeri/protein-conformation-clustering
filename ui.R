...
shinyUI(fluidPage(
    ...
    tabsetPanel(
      # =================== TAB STEP 1 ========================================    
      tabPanel(p(strong("Step 1:"), "Leader clustering"),
        fluidRow(
            column(9,
                wellPanel(
                    helpText(p("Welcome to protein conformational clustering!"),
        ...
        fluidRow(
          ...
          column(4,
                wellPanel(
                   ...
                   textInput(inputId="dcdFrequency", label="DCD frequency (ns)", 
                             placeholder="e.g. 0.1"),
                   textInput(inputId="chainId", label = "PDB chain identifier/s", 
                             placeholder="e.g. A or A,B for dimers e.t.c. "),
                   selectInput(inputId="atomTypes", label="Atom set for clustering",
                               choices=c("Calpha"="CA", "Backbone"="C,O,N,CA")),
                   sliderInput(inputId="cutoff", label = "RMSD cutoff for clustering (Å)", 
        ...
        column(8,
               ...
               wellPanel(
                   ...
                   wellPanel(
                       ...
                       fluidRow(
                           column(6,
                             textInput(inputId="NGuess", label="", 
                           ...
                           column(6, align="right",
                             textInput(inputId="charTimeGuess", label="", 
    ...
    bsModal("tab1Expain", title = "Leader clustering of MD protein trajectories", 
            trigger = "readMoreTab1Link",
            h4("Input"),
            tags$ul(
            tags$li(strong("Files:"), "Provide a molecular 
    ...
    # ========================== TAB STEP 2 ====================================
    tabPanel(p(strong("Step 2:"), "Visualizing the leaders"),
        fluidRow(
            column(9, offset = 1,
                   wellPanel(
                       helpText(p("As a second step, you need to visualize 
        ...
        fluidRow(
          ...
          column(8,
                 ...
                 conditionalPanel("output.renderingComplete =='Rendering completed!'",
                    br(),
                    column(6,
        ...
        bsModal("tab2Expain", title = "Molecular visualization", 
        ...
        bsModal("stridingExplanationModal", title="Striding frequency for visualization",
    ...
    # =========================== TAB STEP 3 ===================================
    tabPanel(p(strong("Step 3:"), "Network of states"),
      fluidRow(            
          column(9, offset = 2,
                    wellPanel(
                        helpText(p("You will now use the clustering of the first step
      ...
      fluidRow(
          column(5,
                 wellPanel(
                     ...
                     choices=c("graphOpt"="layout_with_graphopt",
                               "Fruchterman and Reingold"="layout_with_fr",
                               "GEM"="layout_with_gem",
                               "DrL"="layout_with_drl")
                     ),
                     conditionalPanel('input.drawingAlg=="layout_with_graphopt"',
                        sliderInput(inputId="springConst", label = "Spring constant", 
                                    min=0.1, max = 2, value = 0.6, step = 0.2)
                    ),
                     column(6,
                        textInput(inputId="nodeColor", label = "Node color", 
                                  value = "red", placeholder="e.g. red"),
                        textInput(inputId="minNodeSize", label = "Smallest node", 
                                  value = "20", placeholder="e.g. 20")
                     ),
                     column(6,
                        textInput(inputId="labelColor", label = "Label color", 
                                  value = "white", placeholder="e.g. white"),
                        textInput(inputId="maxNodeSize", label = "Largest node", 
                                  value = "50", placeholder="e.g. 50")
                     ),
                    
                    sliderInput(inputId="labelSize", label = "Label size", 
    ...
    fluidRow(
        column(5,
               wellPanel(
                   ...
                   column(6,
                          textInput(inputId="nodeKinColor", label = "Node color", 
                                    value = "blue", placeholder="e.g. red"),
                          textInput(inputId="minNodeKinSize", label = "Smallest node", 
                                    value = "20", placeholder="e.g. 20")
                   ),
                   column(6,
                          textInput(inputId="labelKinColor", label = "Label color", 
                                    value = "white", placeholder="e.g. white"),
                          textInput(inputId="maxNodeKinSize", label = "Largest node", 
                                    value = "50", placeholder="e.g. 50")
                   ),
                   
                   sliderInput(inputId="labelKinSize", label = "Label size", 
                               min=0.5, max = 3, value = 1.5, step = 0.2),
    ...
    bsModal("tab3Expain", title = "Network of states", 
            ...
            p(strong("Graph drawing with force based algorithms:"), "At the very 
              ...
              tags$a(href="http://igraph.org/c/doc/igraph-Layout.html", 
                      "(see igraph manual)", target="_blank"),". For more info on 
              force-directed algorithms see ",
            tags$a(href="https://en.wikipedia.org/wiki/Force-directed_graph_drawing", 
            ...
            p(strong("Lower panel:"), "The lower panel will take your analysis 
              ...
              downloaded from", tags$a(href="http://micans.org/mcl/", "here", 
              target="_blank"), "(Stijn van Dongen, 2000)")
            )
    ),
    # ====================== TAB README ========================================
    tabPanel("Read me!",
               ...
               fluidRow(
                   column(12,
                      h3("The methodology in a nutshell"),
                       ...
                       p(actionLink("leaderLink", "The leader algorithm"), 
                          " (or leader/follower)
                       ...
                       p(actionLink("pitFall", "With some care"), 
                    ...
                    href="https://dl.dropboxusercontent.com/u/12131949/thesisKalimeri.pdf",                                       "thesis.", target="_blank"))
                         )
                   )
             ),
           wellPanel(
               fluidRow(
                   column(12,
                      ...
                      tags$li(strong("For gromacs users:"), "You may use the ", 
                              tags$a(href="http://mdtraj.org/latest/mdconvert.html",
        ...
        column(4,
               ...
               wellPanel(align = "center",
                   ...
                   tags$ul(
                       br(),
                          tags$li("Methodology on pages 42-46 of this ", 
                               tags$a(
                    href="https://dl.dropboxusercontent.com/u/12131949/thesisKalimeri.pdf",                                       "pdf document", target="_blank")),
                   ...
                   tags$ul(align="left",
                       tags$li(tags$a(href="http://thegrantlab.org/bio3d/", 
                                          "Bio3d, R library", target="_blank")),
                       tags$li(tags$a(href="http://igraph.org/redirect.html", 
                                      "igraph, R library", target="_blank")), 
                       tags$li(tags$a(href="http://www.ks.uiuc.edu/Research/vmd/", 
                                      "Visual Molecular Dynamics", target="_blank")), 
                       tags$li(tags$a(href="http://micans.org/mcl/", 
    ...
    # ============ AUXILIARY MODALS ============================================
    bsModal("pitFallFlex", title = "Using conformational clustering to quantify flexibility", 
            trigger = "pitFall",
            ...
            p(strong("There are several possible pitfalls when comparing proteins
             with each other:"),  
    ...
    bsModal("gromosPseudo", title = "Gromos algorithm", 
        trigger = "gromosLink",
        tags$ul(
    ...
    bsModal("leaderPseudo", title = "Leader/follower algorithm", 
        trigger = "leaderLink",
        tags$ul(
    ...
    bsModal("kmeansPseudo", title = "K-means algorithm", 
        trigger = "kmeansLink",
        tags$ul(
